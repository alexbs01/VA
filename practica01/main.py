...
def main():
    ...
    #imgOut = f.filterImage(img, kernel02)                  # circles1.png
    ...
    #gradient = f.gradientImage(img, "sobel")               # circles1.png
    #imgOut = f.LoG(img, 1.0)                               # circles1.png
    imgOut = f.edgeCanny(img, 1.0, 0.02, 0.6)             # circles1.png
